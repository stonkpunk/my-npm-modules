...
function mesh2PointsWithNeighbors(trisIndex){
    var edges2Pts = {};
    var pts2Edges = {};
    ...
    return sop;//{pts: sop, ngraph: setOfPts2NGraph(sop)};
}

module.exports = {mesh2PointsWithNeighbors: mesh2PointsWithNeighbors}