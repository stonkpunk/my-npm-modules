...
module.exports.processMouseMove = function processMouseMove(sdl, window, cameraEye, cameraTheta, cameraPhi, camera_lookDir, camera_lookDir2, cameraLookTarget, pvMatrix, mouseIsCaptured=true){
    var evt = {
