...
//const rtu = require("./raytrace-utils");
...
function lines2PtsWithNeighbors(sol,r=0.1){
...
module.exports = {simplifyLines2d,linesetFlipAlongZ, sector2LinesEdges, remapTrisToSector, boundingBlockOfTriangles, boundingBlockOfPts, boundingBlockOfLines, boundingBlockOfBlocks, lines2PrismTris, jitterColorF, shiftLine, shiftLines,lines2PtsWithNeighbors, removeDuplicateLines, lineLineClosestPtsLine, averageOfPts, pt2XLines,ptInsideShape, orthoLines2d, orthoDirs2d, brightenColor,crossProductLines,crossProduct, lineDirection,reverseLines, ptDiff,addExtraPt, lineDFHighPt, lineDFLowPt, normalizePt, scalePt,triangleNormalLines, lineLength, lineMidPt, centerOfLine, randomPtFromSetOfLines, normalizeLine,addPts, createStarLinesXZ, lineInsideShape, caliLines2d, caliPts2d, ptsXZInPolygonXZ, ptsXZInPolygonXY, getPointAlongLine_dist, lines2Triangles, createCircleLinesXZ, getPointAlongLine, randomOrthoLineFromSetOfLines, jitterPt, jitterPt3d, normalizeAndCenterLine};