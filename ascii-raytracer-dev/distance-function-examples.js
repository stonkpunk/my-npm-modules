...
var ru = require('./raycasting-utils.js');
...
var dfBlobWorldStatic = function(x,y,z){
    var s = 5.0
    var t = 0;//Date.now()/5000;
...
module.exports = {dfBlobWorldStatic,dfCanyon,dfHillsWorld2D,dfSphere, dfPerlin3D, dfBlobWorld, dfPlanet, dfLavaLamp, dfSkullTrace, dfSkull, dfMaze, dfMazeTrace, dfHillsWorld, dfHillsWorldOctaves, dfCloudWorld};