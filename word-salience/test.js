...
var doPostMultiply = true; //default true - multiplies [frequency/norvig frquency] by number of times the word appears in the text. similar to TF-IDF.
//ws.getSalientWords(theText,returnUnstemmedWords,doMultiplyScoreByWordAppearances)
