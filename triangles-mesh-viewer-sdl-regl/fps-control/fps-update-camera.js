var {buildPVMatrix, buildPVMatrix_parts} = require('./build-pv-matrix.js');
...
function updateCamera(cameraEye, cameraTheta, cameraPhi, camera_lookDir, camera_lookDir2, cameraLookTarget, pvMatrix){
    ...
    pvMatrix= buildPVMatrix(cameraEye, cameraLookTarget, [0,1,0]);
    var pvMatrixParts = buildPVMatrix_parts(cameraEye, cameraLookTarget, [0,1,0]);
