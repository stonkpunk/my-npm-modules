...
var lu = require('../utils/lines-utils.js');
var sos = require('./slide-off-surface.js');

var DO_ENABLE_WALLS = false;

function toggleWalls(_doEnable){
    DO_ENABLE_WALLS = (typeof _doEnable !== 'undefined') ? !DO_ENABLE_WALLS : _doEnable;
}
...
function processKeys(sdl, cameraData, traceFunc, tris){
