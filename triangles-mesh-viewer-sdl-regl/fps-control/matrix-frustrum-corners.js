...
function getCorners(_pvMatrix){
    ...
    var ptsTransf = unitCubePts.map(function(pt){
...
function getOutwardRayXY(_pvMatrix,x=0.5,y=0.5, _pvInv=null){ //x,y 0...1 going across the screen, 0.5,0.5 in the center
